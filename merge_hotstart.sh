...
sgintmeanpath=/home/g/g260204/schism_v5.11/sgint_scripts/make_week_mean_parallel.py
python3 $sgintmeanpath $this_dir $ver
echo "Week mean calculated for $ver"

#calculate sg int
sgintpath=/home/g/g260204/schism_v5.11/sgint_scripts/run_sgint_parallel.py
python3 $sgintpath $this_dir $ver
echo "SG int calculated for $ver"

#calculate POC source
makesourcepath=/home/g/g260204/schism_v5.11/sgint_scripts/create_source/create_source_nc_sep.py
...
updatehotpath=/home/g/g260204/schism_v5.11/sgint_scripts/create_sed_source/sed_source_sep.py
